...
def create_processors_program() -> ArgumentParser:
	...
	group_processors.add_argument('--processors', help = wording.get('help.processors').format(choices = ', '.join(available_processors)), default = config.get_str_list('processors.processors') or [], nargs = '*')
